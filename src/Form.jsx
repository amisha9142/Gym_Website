...
const Navigate = useNavigate();
  return (
    ...
    <img src={back} style={{width:"1000px",height:"500px",objectfit:"contain"}}/>
    </div>
    <div className='absolute' style={{top:"130px",left:"380px"}}>
     <div className='border border-white bg-white rounded-md shadow-2xl' style={{width:"300px",height:"300px"}}>
    <h1 className='font-bold text-center text-2xl mt-5'>Signup</h1>


    <input className='border border-gray-500 mt-4 ml-7 pl-3 rounded-lg' placeholder="enter your email here..." style={{width:"240px",height:"30px"}}/><br/><br/>
    ...
    <button className='border border-black bg-green-900 hover:bg-green-600
     text-white rounded-lg p-1 ml-7 mt-5'>Submit</button><br/>
